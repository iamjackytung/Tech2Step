...
# install yarn extension

# clone repository

# open in whatever program you're using such as VSCode

# create a file named: .env.local

# copy Jacky's .env.local

# copy Jacky's package.json

# yarn run dev

# if there are version issues, eun npm

# To-dos

# Sign-in/Sign-up - easy - Sauhard

# Contacts Page - easy - deepansha
...
# Footer component - easy

# Header component - easy
